...
_styles["bs-success"] = _.defaults({
	borderColor: "#53a753",
	backgroundGradient: _backgroundGradient([{ color: "#38c88e", offset: 0.0 }, { color: "#23c282", offset: 0.1 }, { color: "#1fae75", offset: 1.0 }]),
	activeStyle: {
		backgroundGradient: _backgroundGradient([{ color: "#1fae75", offset: 0.0 }, { color:"#1c9b68", offset: 0.3 }, { color: "#18875b", offset: 1.0 }]),
	},
	disabledStyle: {
		backgroundGradient: undefined,
		backgroundColor: "#23c282",
		opacity: .65
	}
}, _styles['bs-primary']);
